...
public abstract class ModifyData {
    ...
    public abstract void addAirline(String name, String alias, String iata, String icao, String callsign, String country, String active);

    public abstract void addAirport(String name, String city, String country, String iata, String icao, double latitude,
