...
Feature: Reading files
  ...
  Scenario: Reading a valid airline from a file
    Given a file "src/test/java/data/testfiles/normal_airline.txt" with valid airline data
  ...
  Scenario: Reading an invalid airline from a file with less than 7 entries
    Given a file "src/test/java/data/testfiles/airline_too_few_entries.txt" with airline data with too few entries, i.e. less than 7 entries
  ...
  Scenario: Reading an invalid airline from a file "file" with more than 8 entries
    Given a file "src/test/java/data/testfiles/airline_too_many_entries.txt" with airline data with too many entries, i.e. more than 8 entries
  ...
  Scenario: Reading multiple airlines from a file
    Given a file "src/test/java/data/testfiles/abnormal_airlines_multiple.txt" with multiple airlines
  ...
  Scenario: Reading a valid airport from a file
    Given a file "src/test/java/data/testfiles/normal_airport_with_id.txt" with valid airport data
  ...
  Scenario: Reading an invalid airport from a file with less than 11 entries
    Given a file "src/test/java/data/testfiles/airport_too_few_entries.txt" with airport data with too few entries, i.e. less than 11 entries
  ...
  Scenario: Reading an invalid airport from a file with more than 12 entries
    Given a file "src/test/java/data/testfiles/airport_too_many_entries.txt" with airport data with too many entries, i.e. more than 12 entries
  ...
  Scenario: Reading multiple valid airports from a file
    Given a file "src/test/java/data/testfiles/normal_airports_multiple.txt" with multiple airports
  ...
  Scenario: Reading a valid flight entry from a file
    Given a file "src/test/java/data/testfiles/normal_flight_entry.txt" with a single valid flight entry
  ...
  Scenario: Reading a valid flight from a file
    Given a file "src/test/java/data/testfiles/normal_flight.txt" with multiple valid flight entries
  ...
  Scenario: Reading a flight entry from a file with the wrong number of entries, i.e. less or more than 5
    Given a file "src/test/java/data/testfiles/flight_entry_too_few_entries.txt" with a single flight entry with the wrong number of entries, i.e. less or more than 5
  ...
  Scenario: Reading an abnormal flight from a file
    Given a file "src/test/java/data/testfiles/abnormal_flight.txt" with multiple flight data entries, some of them invalid
  ...
  Scenario: Reading a valid route from a file
    Given a file "src/test/java/data/testfiles/normal_route_9_entries.txt" with valid route data
  ...
  Scenario: Reading route data from a file with less than 6 entries
    Given a file "src/test/java/data/testfiles/route_too_few_entries.txt" with route data with too few entries, i.e. less than 6 entries
  ...
  Scenario: Reading route data from a file with more than 6 entries but less than 9 entries
    Given a file "src/test/java/data/testfiles/route_too_many_entries_less_than_9.txt" with route data with the wrong number of entries, i.e. more than 6 entries but has less than 9 entries
  ...
  Scenario: Reading route data from a file with more than 9 entries
    Given a file "src/test/java/data/testfiles/route_too_many_entries.txt" with route data with too many entries, i.e. more than 9 entries
  ...
  Scenario: Reading multiple routes from a file
    Given a file "src/test/java/data/testfiles/abnormal_routes_multiple.txt" with multiple routes
